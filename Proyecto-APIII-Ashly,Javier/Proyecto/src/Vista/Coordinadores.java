...
public class Coordinadores extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Coordinadores");

        listaC.setText("Lista de coordinadores");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(listaC, javax.swing.GroupLayout.PREFERRED_SIZE, 172, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    private void listaCActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_listaCActionPerformed
        CoordinadoresLista ventana = new CoordinadoresLista();
        ventana.setVisible(true);
        this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Coordinadores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Coordinadores().setVisible(true);
            }
        });
    }
