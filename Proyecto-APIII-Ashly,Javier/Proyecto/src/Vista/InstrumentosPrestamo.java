...
public class InstrumentosPrestamo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(Volver);
        Volver.setBounds(380, 300, 70, 30);
        ...
        jPanel2.add(Guardar);
        Guardar.setBounds(170, 270, 150, 30);
        ...
        jPanel2.add(Dia);
        Dia.setBounds(80, 60, 51, 20);

        jLabel5.setText("Mes:");
        jPanel2.add(jLabel5);
        jLabel5.setBounds(183, 62, 40, 14);
        ...
        jLabel8.setText("Año:");
        jPanel2.add(jLabel8);
        jLabel8.setBounds(331, 62, 40, 14);
        ...
        jPanel2.add(Cedula);
        Cedula.setBounds(303, 144, 130, 30);

        jLabel9.setText("Cedula:");
        jPanel2.add(jLabel9);
        jLabel9.setBounds(250, 150, 50, 14);
        ...
        Estudiante.setBounds(110, 140, 100, 30);
